<?php
    ...
    header('Location: index.php?error=' . urlencode('No se indicó el álbum a borrar.'));
    exit();
    }
    ...
    try {
        ...
        header('Location: index.php?ok=1&msg=' . urlencode('Álbum y canciones borrados correctamente.'));
        exit();
        ...
        header('Location: album.php?cod=' . $codigo . '&error=' . urlencode('Error al borrar: ' . $e->getMessage()));
        exit();
    }